...
class Experiment():
    def __init__(self, ):
        ...
        self.vocab_monomorph_path = os.path.join('data', 'vocab_controlled.pkl')
        
        # Word ids keyed by word length
        self.ids_by_wordlength_path = os.path.join('data', 'ids_by_wordlength.pkl')
        self.ids_by_wordlength_monomorph_path = os.path.join('data', 'ids_by_wordlength_controlled.pkl')
        ...
        self.dist_scores_monomoprh_dir = os.path.join('results', 'distance_scores_monomoprh')
        self.pairwise_dist_scores_filename = 'pairwise_dist_scores.csv'
        self.avg_dist_scores_filename = 'avg_dist_scores.csv'
        
        # Correlation files (real, baselines, differences between real and baselines)
        self.corr_scores_dir = os.path.join('results', 'correlation_scores')
        self.corr_scores_monomorph_dir = os.path.join('results', 'correlation_scores_monomorph')        
        self.real_corr_scores_filename = 'real_corr_scores.csv'
        self.rd_bl_corr_scores_filename = 'rd_bl_corr_scores.csv'
        self.bin_bl_corr_scores_filename = 'bin_bl_corr_scores.csv'
        self.corr_diffs_filename = 'corr_diffs.csv'
